...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-4badd7aeae60d78c"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-4badd7aeae60d78c",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-4badd7aeae60d78c",
        "url": "https://en.wikipedia.org/wiki/Fermat%E2%80%93Catalan_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Fermat–Catalan conjecture : there are finitely many distinct solutions $(a^{m},b^{n},c^{k})$ to the equation $a^{m}+b^{n}=c^{k}$ with $a,b,c$ being positive coprime integers and $m,n,k$ being positive integers satisfying $1/m+1/n+1/k<1$ .",
      "version": 1
    },
    "title": "Fermat–Catalan conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "4be326331e5fbb178329f76708718f7c4fd13c99c5448a6bb0acac214c5b9d66"
}
```
